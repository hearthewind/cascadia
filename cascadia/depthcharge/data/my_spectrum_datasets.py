...
from .my_parsers_v3 import MsgpParser
from .. import utils
...
class SpectrumDataset(Dataset):
    ...
    def _get_parser(
        ...
        if ms_data_file.suffix.lower() == ".csv":
            return MsgpParser(ms_data_file, **kw_args)
...
class AnnotatedSpectrumDataset(SpectrumDataset):
    ...
    def _get_parser(self, ms_data_file: str) -> MsgpParser:
        """Get the parser for the MS data file."""
        if ms_data_file.suffix.lower() == ".csv":
            return MsgpParser(
                ms_data_file,
